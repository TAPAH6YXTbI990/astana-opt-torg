...
def update_client_profile(
    ...
    """Сохрани информацию о клиенте. Вызывай когда клиент сообщает данные о себе: имя, город, тип бизнеса, интересы, объём закупки и т.д. Извлекай ВСЕ данные из сообщения и передавай их все в одном вызове. Можно вызывать несколько раз, обновляя только новые данные."""
    fields: dict[str, Any] = {}
    if name is not None:
        fields["name"] = name
